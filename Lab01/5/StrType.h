...
public:
 ...
 // void GetString(bool skip, InType charsAllowed);
  ...
  // function:  compares self and otherString in alphabetical order
  // condition: self and otherString have been initialized
  // result:    if self comes before otherString -> LESS
  //            if self comes after otherString -> GREATER
  //            if self is equal to otherString -> EQUAL
