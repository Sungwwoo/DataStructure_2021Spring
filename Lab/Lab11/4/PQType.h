...
{
  maxItems = 50;
  items.elements = new NodeType<ItemType>[50];
  length = 0;
}
template<class ItemType>
...
{
  maxItems = max;
  items.elements = new NodeType<ItemType>[max];
  length = 0;
}
...
template<class ItemType>
void PQType<ItemType>::Dequeue(NodeType<ItemType>& item)
...
template<class ItemType>
void PQType<ItemType>::Enqueue(NodeType<ItemType> newItem)
